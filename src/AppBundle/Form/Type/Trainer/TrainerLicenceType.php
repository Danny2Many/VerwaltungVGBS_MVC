...
class TrainerLicenceType extends AbstractType{
     public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder->add('issuedate', DateType::class, array('label' => 'Austellungs Datum:', 'format' => 'yyyy-MM-dd', 'placeholder' => array('year' => 'Jahr', 'month' => 'Monat', 'day' => 'Tag')));
        $builder->add('expirationdate', DateType::class, array('label' => 'Ablauf Datum:','format' => 'yyyy-MM-dd', 'placeholder' => array('year' => 'Jahr', 'month' => 'Monat', 'day' => 'Tag')));
    }
